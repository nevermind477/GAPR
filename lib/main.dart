...
class _MainNavigationPageState extends State<MainNavigationPage> {
  ...
  Widget build(BuildContext context) {
    final pages = [
      ...
      const SquareCalculatorPage(),
      const CircleCalculatorPage(),
      SettingsPage(
...
class SquareCalculatorPage extends StatelessWidget {
  const SquareCalculatorPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Квадрат'), centerTitle: true),
      body: Center(
        child: Column(
...
class CircleCalculatorPage extends StatelessWidget {
  const CircleCalculatorPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Круг'), centerTitle: true),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
